<div class="card  card-xxl-stretch mb-5 mb-xxl-10" data-select2-id="select2-data-128-6kj2">
    <div class="card-header">
        <div class="card-title">
            <h3 class="text-gray-800">Generate Assessment Form for Unifast</h3>
        </div>
    </div>
    <div class="card-body" data-select2-id="select2-data-127-81y9">
        ...
        <span class="fs-5 fw-semibold text-gray-600 pb-6 d-block">Download apart from order of the good awesome invoice
            topics</span>

        <div class="d-flex align-self-center" data-select2-id="select2-data-126-tmza">
            <div class="row w-100">
                <div class="col-lg-6">
                    <div class="flex-grow-1 me-3" data-select2-id="select2-data-125-ip9g">
                       <select class="form-select" data-control="select2" data-placeholder="Select program" id="program_select">
                            <option></option>
                ...
                <div class="col-lg-6">
                    <div class="flex-grow-1 me-3" data-select2-id="select2-data-125-ip9g">
                       <select class="form-select" data-control="select2" data-placeholder="Select year" id="year_select">
                            <option></option>
            ...
            <button type="button" class="btn btn-primary btn-icon flex-shrink-0" tooltip="Generate" flow="up" id="generate_button">
